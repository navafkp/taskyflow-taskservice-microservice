...
from tasks.views import (
    BoardAction, CardAction, ColumnsAction,
    AssigneeDeleteion, CardDeletion, CommentAction, GetComments,
    CardEditUpdate, AddAssignee, CreateMeeting,
    MeetingAction, DeleteBoard, DeleteMeeting
)
...
urlpatterns = [
    ...
    path('card/assignee/<int:id>/', AssigneeDeleteion.as_view(),
         name='delete_card_assignee'),
    ...
    path('meeting/delete/<str:id>/', DeleteMeeting.as_view(),
         name="delete_meeting_actions"),
]
